          ...
          <div class="container">
            <div class="columns is-vcentered">
              <div class="column is-5">
                <h1 class="title is-1 is-bold">yasserApp</h1>
                <h3 class="subtitle is-4 pt-2 light-text">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Isto modo ne improbos quidem.
                </h3>
                <div class="buttons">
                  <VButton bold rounded raised color="primary" @click="login">Connecter</VButton>
                </div>
              </div>
              <div class="column is-7">
                <img class="light-image-l hero-mockup" src="/@src/assets/logo.png" alt="" />
                <img class="dark-image-l hero-mockup" src="/@src/assets/logo.png" alt="" />
              </div>
            </div>
          </div>
        </div>
...
.is-dark {
  .has-bg-dots {
    background-image: radial-gradient(circle, var(--landing-xxx-light-4) 10%, transparent 15%),
