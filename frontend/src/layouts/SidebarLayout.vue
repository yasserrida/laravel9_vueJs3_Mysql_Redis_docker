...
function switchSidebar(id: string): void {
  ...
  <div class="sidebar-layout">
    ...
    <Sidebar :theme="props.theme" :is-open="isDesktopSidebarOpen">
      <template #links>
        ...
        <!-- Messaging -->
        <li>
          <RouterLink id="open-messages" :to="{ name: 'index' }" data-content="Messaging">
      ...
      <template #bottom-links>
        ...
        <!-- Settings -->
        <li class="is-hidden-touch">
          <RouterLink id="open-settings" :to="{ name: 'index' }" data-content="Settings">
